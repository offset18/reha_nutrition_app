...
/*
LineChart for further Statistics
this one takes the weekly taken meds(paracetamol)
 */


class LinechartPainKillers extends StatefulWidget {
  LinechartPainKillers({
    super.key,
    Color? lineColor,
  ...
  List<String> get weekDays =>
      const ['Sat', 'Sun', 'Mon', 'Die', 'Mit', 'Don', 'Frei'];

  List<double> get yValues => const [250, 500, 1000, 750, 500, 250,750];

  @override
  State createState() => _LinechartPainKillersState();
}

class _LinechartPainKillersState extends State<LinechartPainKillers> {
