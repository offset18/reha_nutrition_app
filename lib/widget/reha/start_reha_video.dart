...
class StartRehaVideo extends StatefulWidget {
  ...
  @override
  _StartRehaVideoState createState() => _StartRehaVideoState();
}

class _StartRehaVideoState extends State<StartRehaVideo> {
  ...
  void initState() {
    ...
    _chewieController = ChewieController(
        ...
        materialProgressColors: ChewieProgressColors(playedColor: ThemeColors.primCol1));
    super.initState();
  }
